...
function DashboardContent() {
  ...
  const getQuickActions = (role: string) => {
    const baseActions = [
      ...
      { title: 'Generate Proposal', href: '/proposals', icon: '📊', description: 'Create client proposals' },
      { title: 'Chat', href: '/chat', icon: '💬', description: 'Ask questions about products' },
    ];
    ...
    switch (role) {
      case UserRole.MASTER:
        return [
          ...baseActions,
          { title: 'System Admin', href: '/master', icon: '🏛️', description: 'Cross-company administration' },
        ];
      case UserRole.SUPER_ADMIN:
        return [
          ...baseActions,
          { title: 'Admin Panel', href: '/admin', icon: '⚙️', description: 'Company administration' },
        ];
      case UserRole.ADMIN:
        return [
          ...baseActions,
          { title: 'Manage Users', href: '/admin/users', icon: '👥', description: 'Manage team members' },
        ];
      case UserRole.ADVISOR:
        return [
          ...baseActions,
          { title: 'My Clients', href: '/clients', icon: '👤', description: 'Manage your clients' },
        ];
      case UserRole.LEADER_1:
      case UserRole.LEADER_2:
        return [
          ...baseActions,
          { title: 'Team Dashboard', href: '/team', icon: '📈', description: 'View team performance' },
        ];
      case UserRole.SENIOR_PARTNER:
        return [
          ...baseActions,
          { title: 'Analytics', href: '/analytics', icon: '📊', description: 'Strategic insights' },
        ];
      default:
        return baseActions;
    }
